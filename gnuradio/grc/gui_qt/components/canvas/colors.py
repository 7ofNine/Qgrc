...
BLOCK_MISSING_BACKGROUND_COLOR = get_color('#FFF2F2')
BLOCK_MISSING_BORDER_COLOR = get_color('#FF0000')
...
CONNECTION_HIGHLIGHT_COLOR = HIGHLIGHT_COLOR
CONNECTION_DEFAULT_COLOR = get_color('#616161')
